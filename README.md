...
- **Real lower:** $K_G^{\mathbb R}\ge 1625\pi/2917=1.750115893755027\ldots$. [Proof and verification](real/lower/).
...
The companion [Li et al., arXiv:2608.11195v3, Section 3](https://arxiv.org/html/2608.11195v3) reports stronger internally tested real claims, including $51\pi/92$ and $1.7813319810625639$, while explicitly not stating them as theorems. Our reported endpoints are numerically stronger than those claims as well. The distinction in verification status is retained in the comparison document.

## Methods

- The real lower proof bounds a Gaussian operator formed from the first and third Hermite projections, using constraints on sign midpoints, a circle inequality, and one-dimensional certificates. Finite approximation gives matrix witnesses.
